	...
	theme: {
		extend: {
			...
			boxShadow: {
				...
				"inset-primary":
					`inset 2px 2px 4px var(--primary-dark), inset -2px -2px 4px var(--primary-light)`,
				"outset-error": `0 0 8px var(--error)`,
				"outset-secondary": `0 0 8px var(--secondary)`,
				"outset-light":
					`2px 2px 4px var(--light-dark), -2px -2px 4px var(--light-light)`,
				"outset-dark":
					`2px 2px 4px var(--dark-dark), -2px -2px 4px var(--dark-light)`,
				"inset-light":
					`inset 2px 2px 4px var(--light-dark), inset -2px -2px 4px var(--light-light)`,
				"inset-dark":
					`inset 2px 2px 4px var(--dark-dark), inset -2px -2px 4px var(--dark-light)`,
				...
				"pressed-light":
					`1px 1px 2px var(--light-dark), -1px -1px 2px var(--light-light)`,
				"pressed-dark":
					`1px 1px 2px var(--dark-dark), -1px -1px 2px var(--dark-light)`,
			},
		},
	},
	plugins: [
