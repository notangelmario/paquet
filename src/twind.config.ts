		...
		theme: {
			extend: {
				...
				boxShadow: ({ theme }) => ({
					...
					"inset-primary": `inset 2px 2px 4px ${theme("colors.primary.dark")
					...
					"outset-light": `2px 2px 4px ${theme("colors.light.dark")
						}, -2px -2px 4px ${theme("colors.light.light")}`,

					"outset-dark": `2px 2px 4px ${theme("colors.dark.dark")
						}, -2px -2px 4px ${theme("colors.dark.light")}`,
					"inset-light": `inset 2px 2px 4px ${theme("colors.light.dark")
						}, inset -2px -2px 4px ${theme("colors.light.light")}`,
					"inset-dark": `inset 2px 2px 4px ${theme("colors.dark.dark")
					...
					"pressed-light": `1px 1px 2px ${theme("colors.light.dark")
						}, -1px -1px 2px ${theme("colors.light.light")}`,
					"pressed-dark": `1px 1px 2px ${theme("colors.dark.dark")
